...
local function status_icon(icon, status)
    if status then
        if status == "pause" then return icon.test_run
        elseif status == "cont" then return icon.test_run
        elseif status == "run" then return icon.test_run
        elseif status == "fail" then return icon.test_fail
        elseif status == "pass" then return icon.test_pass
        elseif status == "skip" then return icon.test_skip
        end
    end
end
